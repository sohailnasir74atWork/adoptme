...
export const BADGE_IMAGES = {
  ...
  chatty: require('../../Assets/badges/badge_chatty.png'),
  petParent: require('../../Assets/badges/badge_petParent.png'),
  ...
  quizMaster: require('../../Assets/badges/badge_quizMaster.png'),
  memoryKing: require('../../Assets/badges/badge_memoryKing.png'),
  nightOwl: require('../../Assets/badges/badge_nightOwl.png'),
  helper: require('../../Assets/badges/badge_helper.png'),
  // Rare
