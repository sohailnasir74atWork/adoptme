#!/usr/bin/env node
// Pull vitals + reviews from Play Console for the Adopt Me app.
// Writes CSVs to ../analytics/<date>/.
// Requires: SA key at ../.secrets/play-sa-key.json + APIs enabled +
// SA invited in Play Console with the app authorized.

const fs = require('fs');
const path = require('path');
const { GoogleAuth } = require('google-auth-library');

const PACKAGE = 'com.adoptmevaluescalc';
